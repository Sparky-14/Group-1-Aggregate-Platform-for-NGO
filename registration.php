...
if(isset($_POST['uname'])){
    ...
    include "conn.php";
    $sql = "INSERT INTO `PendingUsersApproval`(`Name`, `Username`, `Password`, `Mobile`, `Email`) VALUES ('$name','$uname','$password','$mobile','$email')";
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" id="f1" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name="uname" id="exampleLastName"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" class="form-control form-control-user" name="mobile" id="exampleMobileNo"
