...
if(isset($_POST['location'])){
    ...
    $sql = "INSERT INTO `UsersProblemApproval`(`Title`, `Sector`, `Problem`, `Location`, `Contact`, `CreatedBy`) VALUES  ('$title', '$sector', '$problem' , '$location', '$mobile', '$createdby')";
    if ($conn->query($sql) === TRUE) {
        echo "<script> alert('Inserted Successfully')</script>";
    }else{
        echo "<script>alert('".$sql."There was some problem')</script>";
    }
}
echo '
<!DOCTYPE html>
        ...
        <section id="services" class="services section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <h2>Add a Problem</h2>
                    <p>NGOs worldwide perform a wide range of services aimed towards human wellbeing and social welfare.
                    </p>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="icon-box" style=" width:100%;">
                        ...
                        <div class="container text-center my-2">
                            ...
                            <div>
                                <button class="btn-get-started" type="submit">Submit</button>
                            </div>
                        </form>
